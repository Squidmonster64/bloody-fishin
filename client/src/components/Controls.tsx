/** Controls — location selector, date range, custom lat/lon input */
...
export function Controls({ state, onLocationChange, onDaysChange, onCustomLocation }: Props) {
  ...
  return (
    <div className="bg-[#0d1f3c] border-b border-[#1e3a5f] px-3 py-2 flex flex-wrap items-center gap-2">
      ...
      <div className="flex items-center gap-1.5 min-w-0">
        ...
        <select
          className="bg-[#0a1628] border border-[#1e3a5f] text-white text-xs rounded px-2 py-1.5 min-w-0 max-w-[200px] sm:max-w-xs focus:border-[#ff6b35] focus:outline-none"
      ...
      <div className="flex items-center gap-1.5">
        ...
        <select
          className="bg-[#0a1628] border border-[#1e3a5f] text-white text-xs rounded px-2 py-1.5 focus:border-[#ff6b35] focus:outline-none"
          value={state.days}
            ...
            <form onSubmit={handleCustomSubmit} className="flex flex-col gap-3">
              <div>
                ...
                <input
                  ...
                  placeholder="-32.06"
                  className="w-full bg-[#0a1628] border border-[#1e3a5f] text-white text-sm rounded px-3 py-2 focus:border-[#ff6b35] focus:outline-none"
                />
              </div>
              <div>
              ...
              <div className="flex gap-2 mt-1">
                <button type="submit"
                  className="flex-1 bg-[#ff6b35] text-white text-sm font-bold py-2 rounded hover:bg-[#e55a2b] transition-colors active:scale-95">
                  Load
                </button>
                <button type="button" onClick={() => setShowCustom(false)}
                  className="flex-1 bg-[#1e3a5f] text-white text-sm py-2 rounded hover:bg-[#2a4f7a] transition-colors active:scale-95">
                  Cancel
                </button>
              </div>
            </form>
